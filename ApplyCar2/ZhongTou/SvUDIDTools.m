...
static const char kKeyChainUDIDAccessGroup[] = "V2X6SSF779.com.xiu.zoshow.iPhone";
...
+(NSString *)app_phone_device
{
    ...
    NSLog(@"%@===%@",phoneVersion,iponeM);
    NSString *iphoeVersion = [NSString stringWithFormat:@"%@%@",iponeM,phoneVersion];
    return iphoeVersion;
