 ...
 */
//   相册列表页面左边返回箭头图片
#define WPhoto_Btn_Back      [UIImage imageNamed:@"back"]
//   图片选中状态图片
#define WPhoto_Btn_Selected       [UIImage imageNamed:@"photo_select_hight"]
//   图片未选中状态图片
#define WPhoto_btn_UnSelected     [UIImage imageNamed:@"photo_select"]
