...
-(void)updateConstraints
{
    ...
    if (!didSetupConstraints) {
        ...
        [self.imagView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:25*KWIDTH];
        ...
        [self.titleLabel autoSetDimensionsToSize:CGSizeMake(screen_width-50, 33*KWIDTH)];
        ...
        [self.detailLabel autoSetDimensionsToSize:CGSizeMake(10*KWIDTH, 30*KWIDTH)];
